...
export class SRTDataService {
  ...
  public GetAll(): Observable<InternalRpl[]> {
  ...
  public GetSingle(id: number): Observable<InternalRpl> {
    return this.http.get(this.cfg.Server)
      .map((response: Response) => <InternalRpl>response.json());
  }

  public Add(itemName: string): Observable<InternalRpl> {
  ...
  public Update(id: number, itemToUpdate: InternalRpl): Observable<InternalRpl> {
